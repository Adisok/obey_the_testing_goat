...
class NewVisitorTest(StaticLiveServerTestCase):
	...
	# She is invited to enter a to-do item straight away
		...
		inputbox.send_keys('Buy peacock feathers') # wpisywanie do elementow typu input
	...
	def test_multiple_users_can_start_lists_at_different_urls(self):
		...
		## of Edith's is through from cookies etc
	...
	def test_layout_and_styling(self):
		...
		# She notices that inpub box is nicely centered
		inputbox = self.browser.find_element_by_id("id_new_item")
		...
		# She starts a new list and ses the input is nicely centered there too
